...
* * *
[^1]: Une première run classique, une run "Nightmare", une run "low-level", et une run facile, tout en prenant soi d'obtenir tous les trophées de relation entre les personnages principaux.
